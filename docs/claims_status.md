...
| `ON_HOLD` | Hold → `POST /v1/claims/verification/hold` | Verifier chooses **Hold** | Case retained in verifier queue | Loops back to the verification queue for later action |
