// Event-based gateway — Waits for whichever event fires first (a message or a timeout) and follows that path.
//
...
// docs/bpm-nodes/event-based-gateway/engine.json.
