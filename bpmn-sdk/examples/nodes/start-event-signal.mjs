// Start event (signal) — A signal start — a broadcast signal spins up a new instance.
//
...
// docs/bpm-nodes/start-event-signal/engine.json.
...
if (isMain(import.meta.url)) {
  ...
  console.log("Start event (signal)");
