// Transaction sub-process — A transactional sub-process — its work commits or compensates as a unit.
//
...
// docs/bpm-nodes/subprocess-transaction/engine.json.
