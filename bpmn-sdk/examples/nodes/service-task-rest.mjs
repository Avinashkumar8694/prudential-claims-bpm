// Service task (REST) — A REST call via the pru-rest-executor — the SDK builds the request payload and parses the response back into variables.
//
...
// docs/bpm-nodes/service-task-rest/engine.json.
