// Intermediate catch (timer) — Pauses the token for a fixed duration before continuing.
//
...
// docs/bpm-nodes/intermediate-catch-timer/engine.json.
