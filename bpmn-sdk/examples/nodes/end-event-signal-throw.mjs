// End event (signal throw) — A signal-throwing end — finishes the path and broadcasts a signal to start downstream work.
//
...
// docs/bpm-nodes/end-event-signal-throw/engine.json.
...
if (isMain(import.meta.url)) {
  ...
  console.log("End event (signal throw)");
