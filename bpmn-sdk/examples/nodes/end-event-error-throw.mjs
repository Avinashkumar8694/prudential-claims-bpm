// End event (error throw) — An error-throwing end — aborts the path with an error the caller/boundary can catch.
//
...
// docs/bpm-nodes/end-event-error-throw/engine.json.
...
if (isMain(import.meta.url)) {
  ...
  console.log("End event (error throw)");
