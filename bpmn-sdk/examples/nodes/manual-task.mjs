// Manual task — An offline task the engine only tracks — no work item is executed.
//
...
// docs/bpm-nodes/manual-task/engine.json.
...
if (isMain(import.meta.url)) {
  ...
  const f = model.nodes.find((n) => n.id === "_file");
