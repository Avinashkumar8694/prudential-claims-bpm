// Script task — Runs inline code against the kcontext API (here: resolve a base URL into a process variable).
//
...
// docs/bpm-nodes/script-task/engine.json.
...
if (isMain(import.meta.url)) {
  ...
  const f = model.nodes.find((n) => n.id === "_boot");
